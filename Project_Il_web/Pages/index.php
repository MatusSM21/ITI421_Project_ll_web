...
require_once($_SERVER['DOCUMENT_ROOT'] . '../actions/index.php');
            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Div to display search message -->
                        <div class="search-message">
                            <?php
                            if ($result->num_rows > 0) {
                                echo "<p class='success-message'>Viaje encontrado</p>";
                            } else {
                                echo "<p class='error-message'>Viaje no encontrado</p>";
                            }
                            ?>
                        </div>
                        ...
                        <div class="table">
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<div class='col'>";
                                    echo "<a href='../pages/rides.php?id=" . $row['id'] . "' class='button'>View</a>";
                                    echo "</div>";
                                    echo "</div>";
                                }
                            } else {
