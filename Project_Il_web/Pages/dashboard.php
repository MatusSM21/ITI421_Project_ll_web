            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="row align-items-start ml-1">
                        ...
                        <div class="col">
                            <a href="../Pages/add_rides.php" class="buttonmain">Rides</a>
                        </div>
                        <div class="col">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="buttonplus" onclick="location.href='../pages/add_rides.php'">
                    ...
                    <div class="buttonplus2" onclick="location.href='../pages/add_rides.php'">
                        <div class="plus horizontal"></div>
                        <div class="plus vertical"></div>
                    </div>
                </div>
